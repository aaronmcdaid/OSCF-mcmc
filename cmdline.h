...
struct gengetopt_args_info
{
  ...
  int init_seedExpand_flag;	/**< @brief Initialize via seed expansion (default=off).  */
  const char *init_seedExpand_help; /**< @brief Initialize via seed expansion help description.  */
  char * save_current_z_truncated_arg;	/**< @brief save the nodes at the end of the edges  (default='').  */
  char * save_current_z_truncated_orig;	/**< @brief save the nodes at the end of the edges  original value given at command line.  */
  const char *save_current_z_truncated_help; /**< @brief save the nodes at the end of the edges  help description.  */
  ...
  unsigned int save_current_z_truncated_given ;	/**< @brief Whether save.current.z.truncated was given.  */
