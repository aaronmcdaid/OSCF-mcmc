...
const char *gengetopt_args_info_help[] = {
  ...
  "      --save.current.z.truncated=STRING\n                                save the nodes at the end of the edges   \n                                  (default=`')",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->save_current_z_truncated_given = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->save_current_z_truncated_arg = gengetopt_strdup ("");
  args_info->save_current_z_truncated_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->save_current_z_truncated_help = gengetopt_args_info_help[19] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->save_current_z_truncated_arg));
  free_string_field (&(args_info->save_current_z_truncated_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->save_current_z_truncated_given)
    write_into_file(outfile, "save.current.z.truncated", args_info->save_current_z_truncated_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "save.current.z.truncated",	1, NULL, 0 },
        { 0,  0, 0, 0 }
      };
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* save the nodes at the end of the edges .  */
          else if (strcmp (long_options[option_index].name, "save.current.z.truncated") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->save_current_z_truncated_arg), 
                 &(args_info->save_current_z_truncated_orig), &(args_info->save_current_z_truncated_given),
                &(local_args_info.save_current_z_truncated_given), optarg, 0, "", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "save.current.z.truncated", '-',
                additional_error))
              goto failure;
